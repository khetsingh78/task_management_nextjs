            ...
            <div className="bg-gray-100 min-h-screen flex items-center justify-center">
                <div className="bg-white p-6 rounded-lg shadow-md w-96">
                    ...
                    <div className="mb-4">
                        ...
                        <textarea id="description" name="description" value={task.description} rows="4" className="w-full px-4 py-2 border rounded-md " placeholder="Enter your description" onChange={inputHandle}></textarea>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mt-6">
                        <button type="submit" className="w-full bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700 focus:outline-none  " onClick={updateTask}>Update</button>
                    </div>
                </div>
            </div>
            <Footer />
